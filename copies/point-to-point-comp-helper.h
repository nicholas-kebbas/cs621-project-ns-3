 ...
 */
#ifndef POINT_TO_POINT_COMP_HELPER_H
#define POINT_TO_POINT_COMP_HELPER_H
 ...
 * "mixins".
 */
class PointToPointCompHelper : public PcapHelperForDevice,
	                   public AsciiTraceHelperForDevice
{
public:
  /**
   * Create a PointToPointCompHelper to make life easier when creating point to
   * point networks.
   */
  PointToPointCompHelper ();
  virtual ~PointToPointCompHelper () {}
   ...
   * PointToPointCompNetDevice created through PointToPointCompHelper::Install.
   */
   ...
   *
   * Set these attributes on each ns3::PointToPointCompNetDevice created
   * by PointToPointCompHelper::Install
   */
   ...
   * \param value the value of the attribute to set
   *
   * Set these attribute on each ns3::PointToPointCompChannel created
   * by PointToPointCompHelper::Install
   */
   ...
   *
   * This method creates a ns3::PointToPointCompChannel with the
   * attributes configured by PointToPointCompHelper::SetChannelAttribute,
   * then, for each node in the input container, we create a 
   * ns3::PointToPointCompNetDevice with the requested attributes, 
   * a queue for this ns3::NetDevice, and associate the resulting 
   * ns3::NetDevice with the ns3::Node and ns3::PointToPointCompChannel.
   */
...
#endif /* POINT_TO_POINT_COMP_HELPER_H */
