...
#include "point-to-point-comp-helper.h"

namespace ns3 {

NS_LOG_COMPONENT_DEFINE ("PointToPointCompHelper");

PointToPointCompHelper::PointToPointCompHelper ()
{
...
void 
PointToPointCompHelper::SetQueue (std::string type,
...
void 
PointToPointCompHelper::SetDeviceAttribute (std::string n1, const AttributeValue &v1)
{
  m_deviceFactory.Set (n1, v1);
}

void 
PointToPointCompHelper::SetChannelAttribute (std::string n1, const AttributeValue &v1)
{
...
void 
PointToPointCompHelper::EnablePcapInternal (std::string prefix, Ptr<NetDevice> nd, bool promiscuous, bool explicitFilename)
{
  //
  ...
  if (device == 0)
    {
      NS_LOG_INFO ("PointToPointCompHelper::EnablePcapInternal(): Device " << device << " not of type ns3::PointToPointNetDevice");
      return;
    }
...
void 
PointToPointCompHelper::EnableAsciiInternal (
  ...
  bool explicitFilename)
{
  ...
  if (device == 0)
    {
      NS_LOG_INFO ("PointToPointCompHelper::EnableAsciiInternal(): Device " << device << 
...
NetDeviceContainer 
PointToPointCompHelper::Install (NodeContainer c)
{
  NS_ASSERT (c.GetN () == 4);
...
NetDeviceContainer 
PointToPointCompHelper::Install (Ptr<Node> a, Ptr<Node> b)
{
...
NetDeviceContainer 
PointToPointCompHelper::Install (Ptr<Node> a, std::string bName)
{
...
NetDeviceContainer 
PointToPointCompHelper::Install (std::string aName, Ptr<Node> b)
{
...
NetDeviceContainer 
PointToPointCompHelper::Install (std::string aName, std::string bName)
{
  Ptr<Node> a = Names::Find<Node> (aName);
  Ptr<Node> b = Names::Find<Node> (bName);
  return Install (a, b);
